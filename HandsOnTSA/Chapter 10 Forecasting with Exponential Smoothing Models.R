...
# -------- Code Chank 8 --------
# Setting the full weight on the seasonal lag is equivalent to the seasonal 
# Naïve model.
...
# The WMA model for weighting the first lag with 0.2 and the seasonal 
# lag (lag12) with 0.8: 
...
# -------- Code Chank 10 --------
# demonstrates the decay of the weights of the observations on the most 
