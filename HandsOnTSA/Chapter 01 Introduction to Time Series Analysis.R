...
# The operator AND, will return TRUE only if both a and b are TRUE
if(a & b){ 
  print("a AND b are true")
} else print("a AND b are flase")

# The operator OR, will return FALSE only if both a and b are FALSE
if(a | b){ 
...
# this is another way to use if else stetment
d <- ifelse(a >= c, "a is greater or equal to c", "a is smaller than c") 
print(d)
...
# The search() function provides an overview about the loaded 
